  ...
  useEffect(() => {
    received?.map((transaction: Transaction) => {
      if (
        ...
        toast({
          title: "New Transaction",
          description: `OTC Bridge received ${toEther(transaction.value)} ETH`,
          status: "success",
          duration: 9000,
          isClosable: true,
          position: "top",
  ...
  if (chainId !== Ethereum.chainId) {
    return (
      <Box
        ...
        textColor="white"
      >
        <Text>Switch to Ethereum to view this page</Text>
        <button onClick={() => switchChain(Ethereum.chainId)}>
          Switch to Ethereum
        </button>
      </Box>
    );
    ...
    <>
      ...
      >
        ...
        <Text textAlign={"center"} mb={10}>
          Your ETH Balance: {balance?.displayValue} {balance?.symbol}
        </Text>
        <Divider mb={10} />
        <Text textAlign={"center"} mb={10}>
        ...
        <Text textAlign={"center"} mb={10}>
          Remaining value in ETH to purchase:{" "}
        ...
        <Text textAlign={"center"} mb={10}>
          Step 1: transfer your chosen input amount of ETH to the OTC bridge
